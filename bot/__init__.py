...
class Var:
    ...
    OWNER_ID = int(getenv("OWNER_ID", "1242011540"))
    ...
    FFCODE_HDRIP = getenv("FFCODE_HDRIP") or "Hdrip"  # Rename to Hdrip without encoding
    ...
    QUALS = getenv("QUALS", "Hdrip 480 720 1080").split()  # Replace 360p with Hdrip, keep others
